...
type Text2Image interface {
	DiffusionModel(context.Context, *String) (*NumpyArray, error)
}
...
func (c *text2ImageProtobufClient) DiffusionModel(ctx context.Context, in *String) (*NumpyArray, error) {
	...
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *String) (*NumpyArray, error) {
			...
			if resp != nil {
				typedResp, ok := resp.(*NumpyArray)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*NumpyArray) when calling interceptor")
				}
...
func (c *text2ImageProtobufClient) callDiffusionModel(ctx context.Context, in *String) (*NumpyArray, error) {
	out := new(NumpyArray)
...
func (c *text2ImageJSONClient) DiffusionModel(ctx context.Context, in *String) (*NumpyArray, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.server")
	ctx = ctxsetters.WithServiceName(ctx, "Text2Image")
	ctx = ctxsetters.WithMethodName(ctx, "DiffusionModel")
	caller := c.callDiffusionModel
...
func (c *text2ImageJSONClient) callDiffusionModel(ctx context.Context, in *String) (*NumpyArray, error) {
	out := new(NumpyArray)
...
func (s *text2ImageServer) serveDiffusionModelJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *String) (*NumpyArray, error) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *NumpyArray and nil error while calling DiffusionModel. nil responses are not supported"))
		return
	}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
